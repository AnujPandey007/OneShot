        ...
        <div className="container flex flex-wrap items-center justify-between mx-auto">
            ...
            <div className="block w-auto" id="navbar-default">
              <ul className='flex flex-row p-10 text-sm font-medium bg-white'>
                ...
                {isAuth && <li>
                  <Link onClick={handleLogout} className="block py-2 text-gray-400 hover:text-black dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 dark:hover:bg-transparent">Logout</Link>
                </li>}
              </ul>
            </div>
